    ...
    return (
      <header className="z-100">
        <div className="pl-20 justify-end flex flex-col h-96 w-screen bg-gray-500 bg-poker-image bg-cover bg-blend-overlay">
          <h1 className="font-serif text-gray-100 drop-shadow-2xl text-8xl inset-x-48 inset-y-44">
            Stack Tracker:
          </h1>
          <h2 className="font-serif text-gray-100 text-6xl py-5 inset-x-48 inset-y-96">
            The Poker Bankroll App
          </h2>
        </div>
        <nav>
            ...
            <div className="group">
              <li>
                ...
                <ul className="bg-gray-800 transform scale-0 text-center p-6 group-hover:scale-100 absolute transition duration-150 ease-in-out origin-top w-max">
                  <Link to="/dashboard">
                    <li className="py-2 hover:text-gray-600 transform hover:scale-110 duration-75">
                      Dashboard
                    </li>
                  </Link>
                  <Link to="/sessions">
